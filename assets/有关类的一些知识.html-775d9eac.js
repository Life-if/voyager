import{_ as n,o as s,c as a,f as t}from"./app-c8122758.js";const e={},p=t(`<h3 id="有关类的一些知识" tabindex="-1"><a class="header-anchor" href="#有关类的一些知识" aria-hidden="true">#</a> 有关类的一些知识</h3><p>因为python 的类的情况比起C++简单了很多，这里就只说一下有些需要注意的事情</p><ul><li><p><strong>私有与公有成员</strong></p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code>__init__  或者__xxx__  是系统特殊成员（前后两条下划线）
_xxx 是保护成员（前面一条下划线）
