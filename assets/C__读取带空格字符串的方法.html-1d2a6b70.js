import{_ as n,o as e,c as s,f as i}from"./app-ebd99713.js";const a={},l=i(`<h3 id="_1-cin" tabindex="-1"><a class="header-anchor" href="#_1-cin" aria-hidden="true">#</a> 1. cin</h3><p>cin是C++中最常用的输入语句，当遇到空格或者回车键即停止。</p><div class="language-c++ line-numbers-mode" data-ext="c++"><pre class="language-c++"><code>#include&lt;iostream&gt;
#include&lt;stdio.h&gt;
#include&lt;string&gt;
#include&lt;algorithm&gt;
using namespace std;
